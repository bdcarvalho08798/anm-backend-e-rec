...
class JobApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_application" do
    assert_difference("JobApplication.count") do
      post job_applications_url, params: { job_application: { diplomadegree: @job_application.diplomadegree, email: @job_application.email, job_list_id: @job_application.job_list_id, resume: @job_application.resume, transcriptdegree: @job_application.transcriptdegree } }
    end
  ...
  test "should update job_application" do
    patch job_application_url(@job_application), params: { job_application: { diplomadegree: @job_application.diplomadegree, email: @job_application.email, job_list_id: @job_application.job_list_id, resume: @job_application.resume, transcriptdegree: @job_application.transcriptdegree } }
